# -*- coding: utf-8 -*-
#
# Introduction to Programming with Python documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 27 21:55:38 2012.
#
...
project = u'Python and 🐢&nbsp;Turtles&nbsp;🐢'
copyright = u'2012–2021, OpenTechSchool and contributors, adapted by Alisdair Tullo for the University of Edinburgh'
...
try:
    ...
    import datetime
    version = datetime.datetime.strftime("%Y-%m-%dAWT")
else:
...
htmlhelp_basename = 'IntroductiontoProgrammingwithPythondoc'
...
latex_documents = [
  ('index', 'IntroductiontoProgrammingwithPython.tex', u'Introduction to Programming with Python Documentation',
   u'OpenTechSchool', 'manual'),
]
...
man_pages = [
    ('index', 'introductiontoprogrammingwithpython', u'Introduction to Programming with Python Documentation',
     [u'OpenTechSchool'], 1)
]
...
texinfo_documents = [
  ('index', 'IntroductiontoProgrammingwithPython', u'Introduction to Programming with Python Documentation',
   u'OpenTechSchool', 'IntroductiontoProgrammingwithPython', 'One line description of project.',
   'Miscellaneous'),
]
